...
由于本工具不提供刮削功能,如果你需要刮削，推荐javsp、mdcx。使用本工具前需要先使用其他工具将视频文件进行刮削和文件归类处理，这样便于工具扫描本地的nfo文件，并进行信息搜集和入库处理。
...
* O2O脚本（可以查验相关影片正在浏览器的影片本地是否已有,目前支持javbus和javdb）(需要安装油猴脚本管理工具)
